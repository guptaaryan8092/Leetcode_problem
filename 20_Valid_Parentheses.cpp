...
int main() {
    Solution solution;
    string input = "({[]})";  // test case 1: valid
    cout << boolalpha << solution.isValid(input) << endl;  // expected output: true

    input = "({[}]";  // test case 2: invalid
    cout << boolalpha << solution.isValid(input) << endl;  // expected output: false

    input = "([)]";  // test case 3: invalid
    cout << boolalpha << solution.isValid(input) << endl;  // expected output: false

    input = "{[]}";  // test case 4: valid
    cout << boolalpha << solution.isValid(input) << endl;  // expected output: true
